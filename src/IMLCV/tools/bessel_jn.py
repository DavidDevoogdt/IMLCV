...
def _besseljn_power_series(z, v, maxiter: int = 100):
    """
...
def _besseljn_backward_recurrence(z, v, n_iter: int):
    """
...
def _besseljn_forward_recurrence(z, v):
    """
    ...
    return (
        ...
        * jnp.select(
            ...
            [
                ...
                _besseljn_backward_recurrence(zabs, v=vabs, n_iter=n_iter),  # type: ignore
