    ...
    def data_loader(
        ...
        for cvi in cvrnds:
            ...
            if load_weight:
                ...
                neb_c = [jnp.ones((spi.shape[0])) for spi in sp_c]
                ...
                n_samples_eff_total += sum([spi.shape[0] for spi in sp_c])
        ...
        if out == -1:
            ...
            out_weights = [a * b for a, b in zip(weights, density)]
            out_rho = [a / c for a, c in zip(p_select, n_bin)]
