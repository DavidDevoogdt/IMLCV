...
`IMLCV` documentation uses [Sphinx] as its main documentation compiler.
...
[repository]: https://github.com/<USERNAME>/IMLCV
[issue tracker]: https://github.com/<USERNAME>/IMLCV/issues
